...
class SendForgotPasswordMailController {
    handle(request, response) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const sendForgotPasswordMailService = tsyringe_1.container.resolve(SendForgotPasswordMailUseCase_1.SendForgotPasswordMailUseCase);
            yield sendForgotPasswordMailService.execute({
                email,
            });
