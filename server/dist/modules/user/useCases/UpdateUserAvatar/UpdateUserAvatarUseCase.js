...
let UpdateUserAvatarUseCase = class UpdateUserAvatarUseCase {
    ...
    execute({ id, avatarFileName, }) {
        return __awaiter(this, void 0, void 0, function* () {
            const { avatar } = yield this.UsersRepository.findById(id);
            if (avatar)
                yield (0, file_1.deleteFile)(`./tmp/avatar/${avatar}`);
            yield this.UsersRepository.pathAvatar({ id, avatarFileName });
        });
    }
};
